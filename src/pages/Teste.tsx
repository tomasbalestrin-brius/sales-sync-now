  ...
  const syncGoogleSheets = async () => {
    ...
    try {
      const payload = syncMode === "month"
        ? { targetMonth: selectedDate ? format(selectedDate, "yyyy-MM") : format(new Date(), "yyyy-MM"), productName: "Teste" }
        : { targetDate: selectedDate ? format(selectedDate, "yyyy-MM-dd") : format(new Date(), "yyyy-MM-dd"), productName: "Teste" };
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie e acompanhe seus leads do funil Teste
          </p>
        </div>
